...
More than that, given the above description of the official methodology, it is evident that these counts do not claim to and cannot represent the true number of casualties of the war on Gaza. Reporting on expert estimates serves to acknowledge the full scale of human suffering, honouring victims who may not be included in official tallies. It provides a scientifically-grounded counterpoint to potential underreporting, maintaining integrity in casualty documentation. Importantly, these estimates challenge narratives that may downplay the severity of the conflict's impact on civilians. By presenting both official figures and expert estimates, we strive for a more truthful representation of the devastating toll this conflict has taken on human life in Gaza, ensuring that the full extent of the tragedy is not overlooked or minimised in public discourse and policy decisions.
