...
Several [independent analyses from the UN, WHO, and researchers](https://www.ochaopt.org/content/reported-impact-snapshot-gaza-strip-19-june-2024) have confirmed that the data, which even the [IDF](https://www.vice.com/en/article/y3w4w7/israeli-intelligence-health-ministry-death-toll) makes use of, is accurate. This data is processed and made available by the [Tech For Palestine datasets project](https://data.techforpalestine.org/).
...
Even with these inherently conservative numbers, the extent of human suffering in Gaza is unprecedented:
...
Consequently, the work of independent researchers is vital in providing a counterweight to the MoH's limitations and attempting to estimate the true human cost of the war.
...
Devi Sridhar's [previous estimate](https://www.theguardian.com/commentisfree/2023/dec/29/health-organisations-disease-gaza-population-outbreaks-conflict) was 500.000 by end of year, which she revised based on The Lancet study's estimate.
...
The trendline here does not show an inflection point, but seems linear until 2025 (date of the latest estimate available). This is consistent with the inclusion of indirect deaths into the counts: even with a ceasefire, which would stop direct war-related deaths, indirect deaths will lag that inflection point:
...
The deaths due to the effects of war will be long-ranging, and the inflection point might take years to materialise.
